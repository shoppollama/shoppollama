...
#
#     PHX_SERVER=true bin/shoppollama start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :shoppollama, ShoppollamaWeb.Endpoint, server: true
end
...
if config_env() == :prod do
  database_path =
    System.get_env("DATABASE_PATH") ||
      ...
      For example: /etc/shoppollama/shoppollama.db
      """
  ...
  config :shoppollama, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
  ...
  config :shoppollama, ShoppollamaWeb.Endpoint,
    ...
    live_view: [signing_salt: "I5xmirkH"],
    check_origin: false  # Allow all origins for development
  ...
  #
  #     config :shoppollama, Shoppollama.Mailer,
