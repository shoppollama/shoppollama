defmodule ShoppollamaWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    #   Gettext.dngettext(ShoppollamaWeb.Gettext, "errors", msg, msg, count, opts)
    # else
    #   Gettext.dgettext(ShoppollamaWeb.Gettext, "errors", msg, opts)
    # end
